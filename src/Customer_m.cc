...
void Customer::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->items);
...
omnetpp::simtime_t Customer::getWaitingTime() const
{
    return this->waitingTime;
}

void Customer::setWaitingTime(omnetpp::simtime_t waitingTime)
{
...
int CustomerDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "items") == 0) return baseIndex + 1;
    if (strcmp(fieldName, "waitingTime") == 0) return baseIndex + 2;
...
const char *CustomerDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "int",    // FIELD_id
        "int",    // FIELD_items
        "omnetpp::simtime_t",    // FIELD_waitingTime
    };
...
std::string CustomerDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_items: return long2string(pp->getItems());
        case FIELD_waitingTime: return simtime2string(pp->getWaitingTime());
        default: return "";
    }
}
...
void CustomerDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_items: pp->setItems(string2long(value)); break;
        case FIELD_waitingTime: pp->setWaitingTime(string2simtime(value)); break;
...
omnetpp::cValue CustomerDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_items: return pp->getItems();
        case FIELD_waitingTime: return pp->getWaitingTime().dbl();
...
void CustomerDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_items: pp->setItems(omnetpp::checked_int_cast<int>(value.intValue())); break;
